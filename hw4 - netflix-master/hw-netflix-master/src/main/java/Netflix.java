...
public class Netflix {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, List<Movie>> userWatchLists = null;
        userWatchLists.put("Taylor", List<Movie> taylorList);
        userWatchLists.put("George", List<Movie> georgeList);
        userWatchLists.put("Sarah", List<Movie> sarahList);
        ...
        while (running) {
            ...
            if (response.equals("q")) {
                ...
                List<Movie> watchList = userWatchLists.get(Users )
